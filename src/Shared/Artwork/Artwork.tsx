...
import { ConstituentType } from "../ConstituentList/ConstituentList";
import LoaderComponent from "../Loader/Loader";
import { MeasurementType } from "../MeasurementList/MesurementList";
import TagsList, { TagType } from "../TagList/TagList";
import "./Artwork.css";
...
function Artwork({ id, handleImagelessArtwork }: ArtworkProps) {
